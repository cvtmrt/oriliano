...
export const site = {
  ...
  // Meta (Facebook/Instagram) Pixel kimliği — Events Manager'daki 15-16 haneli sayı.
  // BOŞ bırakılırsa pixel HİÇ yüklenmez. Instagram reklamlarının kimin siteye
  // geldiğini görmesi ve retargeting havuzunun dolması için gerekli.
  metaPixelId: "1700011427946941",

  // İletişim
  email: "info@orhankemalkoc.com",
  ...
  // Sosyal — sıra bilinçli: Instagram müşteri kazanım kanalı olduğu için önde.
  social: [
    { label: "Instagram", href: "https://www.instagram.com/orhankemalkoc" },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/orhan-kemal-koc/" },
    { label: "GitHub", href: "https://github.com/oriliano" },
  ],

  // Instagram kullanıcı adı (stüdyo notları bölümünde @ ile gösterilir)
  instagram: "orhankemalkoc",
  instagramUrl: "https://www.instagram.com/orhankemalkoc",
