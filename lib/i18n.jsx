...
export const txt = {
  ...
  heroBadges: [
    ...
    { tr: "Restoran Teknolojisi", en: "Restaurant Tech" },
    { tr: "Yapay Zekâ Görünürlüğü", en: "AI Visibility" },
  ],
  heroPara: {
    tr: "Restoranlardan yerel işletmelere, SaaS panellerinden SEO odaklı web sitelerine kadar; markaların dijitalde daha güçlü görünmesini ve daha iyi çalışmasını sağlıyoruz.",
    en: "From restaurants to local businesses, from SaaS dashboards to SEO-driven websites; we help brands look stronger and work better online.",
  },
